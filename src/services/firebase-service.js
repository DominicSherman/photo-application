...
export const deleteEventByEventId = (env, eventId) => firebase.database().ref(`${env}/events/${eventId}`).remove();

export const deleteUsers = (env, eventId) => firebase.database().ref(`${env}/users/${eventId}`).remove();

export const deleteMedia = (env, eventId) => firebase.database().ref(`${env}/media/${eventId}`).remove();
